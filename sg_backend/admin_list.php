...
$sql = "SELECT id, username, status FROM `user` WHERE role = '$admin_role' and deleted_at IS NULL";
                            ...
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                            ...
                                            $admin_name_edit_path = $cp_base_url . "admin_name_edit.php?id=" . $id; 
                                            $admin_password_edit_path = $cp_base_url . "admin_password_edit.php?id=" . $id; 
                                            $delete_path = $cp_base_url . "admin_delete.php?id=" . $id;
                                             ?>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" last">
                                            <a href="<?= $admin_name_edit_path ?>" class="btn btn-info btn-xs"><i
                                                    class="fa fa-pencil"></i>&nbsp;Name Edit
                                            </a>
                                            <a href="<?= $admin_password_edit_path ?>" class="btn btn-info btn-xs"><i
