...
if(isset($_POST['form-sub']) && $_POST['form-sub'] == 1) {
    ...
    if($process_error == false) {
        ...
        $check = "SELECT count(id) AS total FROM `user` WHERE username = '$admin_name' and deleted_at IS NULL";
        ...
        $sql       = "INSERT INTO `user` (username, password, role, created_at, created_by, updated_at, updated_by) VALUES ('$admin_name', '$md5_password', '$admin_role', '$today_dt', '$user_id', '$today_dt', '$user_id')";
        ...
        if($result) {
            // $url = $cp_base_url."admin_list.php?msg=create";
            // header("Refresh: 0; url = $url");
            // exit();
        }else {
            // $url = $cp_base_url."admin_list.php?err=create";
            // header("Refresh: 0; url = $url");
            // exit();
        }
        }
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="<?= $cp_base_url ?>admin_create.php" method="POST" enctype="multipart/form-data"
                            novalidate>
