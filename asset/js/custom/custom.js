...
function init_daterangepicker_single_call() {
  ...
  $("#startDate").daterangepicker(
    {
      autoUpdateInput: false, // Set to true for auto-update
  ...
  var end_date_picker = $("#endDate").daterangepicker(
    {
      singleDatePicker: true,
  ...
  $("#endDate").click(function () {
    let start = $("#startDate").val() || moment();
    end_date_picker.data("daterangepicker").minDate = moment(
      start,
      "MM/DD/YYYY"
    );
    if (end_date_picker.date("daterangepicker").isShowing) {
      end_date_picker.date("daterangepicker").updateView();
    }
  });
